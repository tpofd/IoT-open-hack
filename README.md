...
| 8     | Развернуть Device Bridge для подключения NB-IoT шлюза к IoT Central ([настройка Device Bridge](https://github.com/Azure/iotc-device-bridge))
Критерий успеха: у команды создано приложение-функция Device Bridge.    |   200 |
